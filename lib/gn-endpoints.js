...
GnEndpoints.prototype.charge = function(charge) {
  return this.post(charge, 'charge');
}

GnEndpoints.prototype.client = function(client) {
  return this.post(client, 'client');
}

GnEndpoints.prototype.pay = function(payment) {
  return this.post(payment, 'pay');
}

GnEndpoints.prototype.paymentMethods = function(options) {
  return this.post(options, 'paymentMethods');
}
