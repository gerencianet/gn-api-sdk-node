...
GnEndpoints.prototype.post = function (object, route) {
  ...
  var getResponse = function (httpResponse, body) {
    return self.options.raw_response ? httpResponse : body;
  }

  var directReqCallback = function (err, httpResponse, body) {
    var response = getResponse(httpResponse, body);
  ...
  var directReq = function () {
    request.post(postParams.call(self, object,
      self.constants.ENDPOINTS[route]), directReqCallback);
  };

  var withTokenReq = function () {
    request.post(postParams.call(self, object,
      self.constants.ENDPOINTS[route]), withTokenReqCallback);
  };
